...
class Profile(models.Model):
    ...
    bio: models.TextField = models.TextField(max_length=500, blank=True, verbose_name="about me")
    agreement_accepted: models.BooleanField = models.BooleanField(default=False)
